...
<div class="main-panel">
  ...
  <h3 class="grid_title ml10 ml15">Manage Case</h3>
                            ...
                            <div id="faq" class="panel-group">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h5 class="panel-title"><span>1.</span> <a data-toggle="collapse" data-parent="#faq" href="#payment-1">Accuser information</a></h5>
                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12 col-md-12">
                                                    ...
                                                    <div class="col-lg-6 col-md-6"><br>
                                                        ...
                                                        <input type="text" class="form-control" placeholder="Accuser Full Name" name="accuser" required value="<?php echo $accuser?>">
                                                    </div>
                                                    <div class="col-lg-6 col-md-6"><br>
                                                    ...
                                                    <div class="col-lg-6 col-md-6"><br>
                                                        ...
                                                        <select name="agender" class="form-control" value="<?php echo $agender?>">
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h5 class="panel-title"><span>2.</span> <a data-toggle="collapse" data-parent="#faq" href="#payment-2">Defendent information</a></h5>
                                    </div>
                                        ...
                                        <div class="panel-body">
                                            <div class="billing-information-wrapper">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-6 col-md-6"><br>
                                                        <label for="gender" class=" form-control-label">Gender</label>
                                                        <select name="dgender" class="form-control" value="<?php echo $dgender?>">
                                                            <option value="">Select Gender</option>
                                                            <option value="M">Male</option>
                                                            <option value="F">Female</option>
                                                        </select>
                                                    ...
                                                    <div class="col-lg-12 col-md-12"><br>
                                                        ...
                                                        <textarea class="form-control" placeholder="Defendent's statement" name="dstatement" id="" cols="30" rows="10" value="<?php echo $dstatement?>"></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h5 class="panel-title"><span>3.</span> <a data-toggle="collapse" data-parent="#faq" href="#payment-3">Case information</a></h5>
                                    </div>
                                        ...
                                        <div class="panel-body">
                                            <div class="shipping-information-wrapper">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-12 col-md-12" id="dish_box1"><br>
