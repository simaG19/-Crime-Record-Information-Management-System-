...
$sql="select cases.*,category from cases,category where cases.category_id=category.id and cases.user_id='".$_SESSION['POLICE_ID']."' and casetype='0' order by cases.id desc";
...
<div class="main-panel">
    <div class="content-wrapper">
        <div class = "main-title">
            ...
            <h6><a href="manage_cases.php" class="grid_sub_title">Add Case</a></h6>
        </div>
                ...
                <div class = "item">
                    ...
                    <div class = "item-detail">
                        ...
                        <div class = "item-price">
                            ...
                            <a href="case_detail.php?id=<?php echo $row['id']?>"><label class="btn btn-primary mr-2 hand_cursor">View Detail</label></a>
                        </div>
