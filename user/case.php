...
$sql="select cases.*,category from cases,category where cases.category_id=category.id and cases.casetype='0' order by cases.id desc";
...
<div class="main-panel">
    <div class="content-wrapper">
        ...
        <div class = "item-list">
                ...
                <div class = "item">
                    <div class = "item-img">
                        <a target="_blank" href="<?php echo LOGO_IMAGE_SITE_PATH."4.jpg"?>">
                            <img src="<?php echo LOGO_IMAGE_SITE_PATH."4.jpg"?>"  width="600" height="200"/>
                        </a>
                    </div>
