...
if(isset($_POST['submit'])){
	...
	if($id==''){
		$user_id=$_SESSION['SUB_ADMIN_USER_ID'];
	...
	if(mysqli_num_rows(mysqli_query($con,$sql))>0){
		...
		if($id==''){
			if($type!='image/jpeg' && $type!='image/png'){
				...
				mysqli_query($con,"insert into cases(user_id,category_id,accuser,aaddress,aphone,pstatement,defendent,dgender,ddob,dmother,dfather,dwork,dfamily,daddress,dphone,dstatement,cine,accusation,imprisioned,arn,status,added_on,image,casetype) values('$user_id','$category_id','$accuser','$aaddress','$aphone','$pstatement','$defendent','$dgender','$ddob','$dmother','$dfather','$dwork','$dfamily','$daddress','$dphone','$dstatement','$cine','$accusation','$imprisioned','$arn',1,'$added_on','$image',1)");
							...
							<div class="contentBx">
								...
								<div class="content">
									...
									<div class="form-group">
										...
										<div class="form-group">
											<label for="exampleInputName1">Phone/Tel Number</label>
											<input type="text" class="form-control" placeholder="Phone/Tel Number" name="aphone" value="<?php echo $aphone?>">
										</div>
