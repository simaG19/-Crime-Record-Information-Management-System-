...
if(isset($_GET['type']) && $_GET['type']!=='' && isset($_GET['id']) && $_GET['id']>0){
    ...
    if($type=='delete'){
		mysqli_query($con,"delete from police where id='$id'");
		redirect('police-grid.php');
	}
	if($type=='active' || $type=='deactive'){
		...
		mysqli_query($con,"update police set status='$status' where id='$id'");
		redirect('police-grid.php');
	}
                ...
                <div class = "item">
                    <div class = "item-img">
                        <a target="_blank" href="img_5terre.jpg">
                            <img src="<?php echo POLICE_IMAGE_SITE_PATH.$row['image']?>" width="600" height="200"/>
                        </a>
                    </div>
                    <div class = "item-detail">
                        <a href = "#" class = "new-price">Name :  <?php echo $row['name']?></a>
                        
                        <div class = "item-price">
                            <span class = "item-name">Station :  <?php echo $row['station']?></span>
                        </div>
