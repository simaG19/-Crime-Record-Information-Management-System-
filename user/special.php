...
$sql="select cases.*,category from cases,category where cases.category_id=category.id and cases.user_id='".$_SESSION['SUB_ADMIN_USER_ID']."' and cases.casetype='1' order by cases.id desc";
                    ...
                    <div class = "item-detail">
                        ...
                        <div class = "item-price">
                            ...
                            if($row['detective_id']=='0'){?>
                                <a href="manage_special.php?id=<?php echo $row['id']?>"><label class="btn btn-dark mr-2 hand_cursor">Edit</label></a>
                            <?php }else{ ?>
