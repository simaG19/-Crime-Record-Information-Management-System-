<?php
include('header.php');
$sql="SELECT * FROM decided WHERE court_decision='criminal' ORDER BY id desc;";
...
<div class="main-panel">
    <div class="content-wrapper">
        <div class = "main-title">
            <h3><strong>Criminal Records</strong></h3>
        </div>
                ...
                <div class = "item">
                    <div class = "item-img">
                        <a target="_blank" href="img_5terre.jpg">
                            <img src="<?php echo LOGO_IMAGE_SITE_PATH."5.png"?>" width="600" height="200"/>
                        </a>
                    </div>
                    <div class = "item-detail">
                        <a href = "#" class = "new-price">Name :  <?php echo $row['defendent']?></a>
                        
                        <div class = "item-price">
                            <span class = "item-name">Crime :  <?php echo $row['casetype']?></span>
                        </div>
                        <a href="criminal_details.php?id=<?php echo $row['id']?>"><label class="btn btn-primary mr-2 hand_cursor">View Detail</label></a>
                    </div>
                </div>
                <?php } ?>
</div>
