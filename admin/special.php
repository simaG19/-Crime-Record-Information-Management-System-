...
$sql="select cases.*,category from cases,category where cases.category_id=category.id and casetype='1' order by cases.id desc";
...
<div class="main-panel">
    <div class="content-wrapper">
        <div class = "main-title">
            ...
            <h6><a href="manage_special.php" class="grid_sub_title">Add Special Case</a></h6>
        </div>
                ...
                <div class = "item">
                    <div class = "item-img">
                        <a target="_blank" href="<?php echo CASE_IMAGE_SITE_PATH.$row['image']?>">
                            <img src="<?php echo CASE_IMAGE_SITE_PATH.$row['image']?>"  width="600" height="200"/>
                        </a>
                    </div>
                    <div class = "item-detail">
                        <span href = "#" class = "item-name">Case :  <?php echo $row['category']?>
                        <?php
                        if($row['user_id']==$_SESSION['ADMIN_ID']){
                        ?>
                        (<b>*</b>)
                        <?php } else { ?>
                        ...
                        <?php
                        echo "<h6>Detective :- ".getDetectiveNameById($row['detective_id'])."</h6>"
                        ?>
                        ...
                        <div class = "item-price">
							...
							<?php } ?>
                            &nbsp;
                            <a href="manage_cases.php?id=<?php echo $row['id']?>"><label class="btn btn-dark hand_cursor">Edit</label></a>&nbsp;
                            <?php } else { ?>
