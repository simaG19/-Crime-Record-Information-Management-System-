...
if(isset($_GET['type']) && $_GET['type']!=='' && isset($_GET['id']) && $_GET['id']>0){
	...
	if($type=='delete'){
		mysqli_query($con,"delete from prision where id='$id'");
	...
	if($type=='active' || $type=='deactive'){
		...
		mysqli_query($con,"update prision set status='$status' where id='$id'");
		redirect('prision.php');
	}

}

$sql="select * from prision order by id asc";
...
<div class="main-panel">
  ...
  <div class="card">
    <div class="card-body">
      <h1 class="grid_title">Station</h1>
			<a href="manage_prision.php" class="add_link">Add Station</a><br><br>
